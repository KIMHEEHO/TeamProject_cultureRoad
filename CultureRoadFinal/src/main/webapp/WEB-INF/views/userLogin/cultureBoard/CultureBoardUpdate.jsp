				...
				<colgroup><col width="20%" /><col width="80%" /></colgroup>
					<tbody>
						<tr>
							<td id="thead">작성자</td>
							<td class="text-left">
								<input type="text" class="form-control" id="userName" name="userName" value="${userLogin.userName }" readonly>
								<input type="hidden" id="userNo" name="userNo" value="${userLogin.userNo }" />
								<input type="hidden" id="ctBoNum" name="ctBoNum" value="${update.ctBoNum }" />
							</td>
						</tr>
						<tr>
							<td id="thead">글제목</td>
							<td class="text-left">
								<input type="text" class="form-control" id="ctBoTitle" name="ctBoTitle" value="${update.ctBoTitle }">
							</td>
						</tr>
						<tr>
							<td id="thead">글내용</td>
							<td class="text-left">
								<textarea rows="10" cols="10" class="form-control" style="resize: none" name="ctBoContent" id="ctBoContent" rows="8">${update.ctBoContent }</textarea>
							</td>
						</tr>
<!-- 							<tr> -->
<!-- 								<td>파일첨부</td> -->
